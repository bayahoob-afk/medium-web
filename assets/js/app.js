  ...
  const nav = `
    <div class="nav-inner">
      ...
      <nav class="nav-links">
        ...
        <a href="medium.html" ${page === "medium" ? 'class="active"' : ""}>หมอดู AI</a>
  ...
  const footer = `
    <div class="container">
      <div class="disclaimer">
        <b>⚠️ คำชี้แจง:</b> บริการดูดวงและหมอดู AI บนแพลตฟอร์ม Medium มีไว้เพื่อความบันเทิง
      ...
      <div class="footer-grid">
        <div>
          ...
          และพบ "หมอดู AI" ที่ศึกษาศาสตร์ความเชื่อมาอย่างลึกซึ้ง</p>
        </div>
        <div>
          <h4>บริการ</h4>
          <a href="seers.html">ค้นหาหมอดู</a>
          <a href="medium.html">หมอดู AI</a>
